      ...
      <div class="row justify-content-center">
          ...
          <ul class="list-group mb-3 sticky-top">
            ...
            >
              <div>
                ...
                <small class="text-muted">Qty:5 </small>
              </div>

              <br />

              <div>
                <span class="text-muted d-flex float-start">Rs. 1200</span
                ><br />
                <span class="text-muted">Subtotal :Rs. 2400</span>
              </div>
            </li>
        ...
        <div class="col-md-7 order-md-1 mine me-2">
          ...
          <form class="needs-validation" method="post" action="">
            ...
            <hr class="mb-2" />
            <button
              class="btn btn-outline-success btn-md btn-block float-end mb-5"
              type="submit"
            >
