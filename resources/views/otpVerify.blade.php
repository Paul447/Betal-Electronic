            ...
            <form class="rounded   bg-white shadow p-5" method="post" action="{{'/otpverify'}}">
                ...
                <h3 class=" fw-bolder fs-4 mb-2 text-success">Vefify Account</h5>
                    <div class="input-group mt-5  mb-3">
                        <input name="otp" type="text" value="" class="form-control form-control-lg" id="password"
                            placeholder="Enter The OTP" required="true" aria-label="password"
                            aria-describedby="basic-addon1" />
                    </div>
                    
                    <button type="submit" class="btn btn-primary submit_btn btn-lg my-4" name="verify">Confirm</button>
            </form>
        </div>
</section>
