...
<canvas id="sales-chart" style="width: 657px; max-width: 800px; margin: 0px auto; display: block; height: 328px;" width="1314" height="656" class="chartjs-render-monitor"></canvas>
<h3 class="justify-content-center d-flex">Batch Based Profit Chart</h3>
<canvas id="myChart" style="width: 657px; max-width: 800px; margin: 0px auto; display: block; height: 328px;" width="1314" height="656" class="chartjs-render-monitor"></canvas>
        ...
        <div class="row g-3 my-2 justify-content-center">
            ...
            <div class="col col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3">
                ...
                <div class="p-3 shadow-sm d-flex justify-content-around align-items-center rounded hello">
                    ...
                    <i class="fas fa-chart-line fs-1 primary-text border rounded-full secondary-bg p-3 mine"></i>
                </div>
            </a>
            </div>
