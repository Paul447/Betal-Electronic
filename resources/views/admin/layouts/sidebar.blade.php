...
<div class="wrapper">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled components">
            ...
            <hr>
            <li class="dropdown nav-items">
                <a href="#homeSubmenu" class="dropdown dropdown-toggle nav-link" data-bs-toggle="collapse"
                    data-bs-target="#product" aria-expanded="false">
                    Product</a>
            ...
            <li class="dropdown nav-items">
                <a href="#homeSubmenu" class="dropdown dropdown-toggle nav-link" data-bs-toggle="collapse"
                    data-bs-target="#brand" aria-expanded="false">Brand</a>
            ...
            <li class="dropdown nav-items">
                <a href="#homeSubmenu" class="dropdown dropdown-toggle nav-link" data-bs-toggle="collapse"
                    data-bs-target="#banner" aria-expanded="false">Banner</a>
            ...
            <li class="dropdown nav-items">
                <a href="#homeSubmenu" class="dropdown dropdown-toggle nav-link" data-bs-toggle="collapse"
                    data-bs-target="#category" aria-expanded="false">Category</a>
            ...
            <li class="dropdown nav-items">
                <a href="#homeSubmenu" class="dropdown dropdown-toggle nav-link" data-bs-toggle="collapse"
                    data-bs-target="#batch" aria-expanded="false">Batch</a>
            ...
            <li class="dropdown nav-items">
                <a href="#homeSubmenu" class="dropdown dropdown-toggle nav-link" data-bs-toggle="collapse"
                    data-bs-target="#delivery" aria-expanded="false">Delivery</a>
            ...
            <li class="dropdown nav-items">
                <a href="#homeSubmenu" class="dropdown dropdown-toggle nav-link" data-bs-toggle="collapse"
                    data-bs-target="#Varition" aria-expanded="false">Varition</a>
            ...
            <li class="dropdown nav-items">
                <a href="#homeSubmenu" class="dropdown dropdown-toggle nav-link" data-bs-toggle="collapse"
                    data-bs-target="#attributesss" aria-expanded="false">Attribute</a>

                <ul class="list-unstyled collapse" id="attributesss">
                   
                    <li>
                        <a href="{{ '/admin/assign/create' }}" class="nav-link" id="">Assign Varition</a>
                    </li>
                    <li>
                        <a href="{{ '/admin/assign/' }}" class="nav-link">View Attribute</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="dropdown nav-items">
                <a href="#homeSubmenu" class="dropdown dropdown-toggle nav-link" data-bs-toggle="collapse"
                    data-bs-target="#Varitionoption" aria-expanded="false">Varition Option</a>

                <ul class="list-unstyled collapse" id="Varitionoption">
                    <li>
                        <a href="{{ '/admin/variationoption/create' }}" class="nav-link" id="">Add
                            VaritionOption</a>
                    </li>
                    <li>
                    ...
                    <div class="input-group">
                      ...
                      <button type="button" class="btn btn-outline-primary">search</button>
                        ...
                        <li class="nav-item navbar-dropdown dropdown-user dropdown px-3">
                            ...
                            <!-- toggeler -->
                            <a role="button" class="nav-link  hide-arrow" href="javascript:void(0);"
                                data-bs-toggle="dropdown">
                                <div class="avatar avatar-online">
                                    <img src="{{ asset('admin/img/mirtyunjayaam-logo.png') }}" height="30px" alt
