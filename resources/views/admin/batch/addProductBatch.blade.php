                ...
                <form action="{{ $url }}" method="post" class="p-4" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="batch" aria-label="Default select example"
                            onchange="fetchProductNotInBatch(this.value)">
                            <option selected>
                                Choose Batch
                            </option>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="mydata" name="costPrice" autocomplete="off"
                            value="" />
                    </div>
                    <div class="mb-3">

                        <label for="recipient-name" class="col-form-label"> Selling Price</label>
                        <input type="number" class="form-control" id="mydata" name="sellprice" autocomplete="off"
                            value="" />
                    </div>
                    <div class="mb-3">

                        <label for="recipient-name" class="col-form-label"> Product Qty</label>
                        <input type="number" class="form-control" id="mydata" name="pqty" autocomplete="off"
                            value="" />
                    </div>
