       ...
       <div class="merobody">
           ...
           <div class="info-container">
               ...
               @if (!is_null(session('customer')))
                   <button a id="" class="add-to-cart" id="addToCartFromCard"
                       value="{{ $product->product_id }}" onclick="fetccchCart(this.value);">Add To Cart</button>
               @else
                   ...
                   <div class="product-card ">
                       ...
                       <div class="product-info">
                           ...
                           <div class="product-buttons">
                               ...
                               @if (!is_null(session('customer')))
                                   <button class="add-to-cart" id="addToCartFromCard"
                                       value="{{ $product->product_id }}" onclick="fetcchCart(this.value);"><i
